import { IsOptional, IsString, IsNumber, IsEmail, IsEnum, ValidateNested, IsArray, Min } from 'class-validator';
...
export class UpdateOrderDto {
  ...
  @ApiPropertyOptional({ description: 'Updated shipping address', type: UpdateShippingAddressDto })
  @IsOptional()
  @ValidateNested()
  @Type(() => UpdateShippingAddressDto)
  shippingAddress?: UpdateShippingAddressDto;

  @ApiPropertyOptional({ description: 'Updated order items', type: [UpdateOrderItemDto] })
  @IsOptional()
  @IsArray()
